...
![width=5.9](docs%2Fimages%2FOverview_figure.png)
## Installation
...
Specific models trained on different sets of plates, imaging channels or bacterial species can be loaded from [Hugging Face](https://huggingface.co/krentzd/ai4ab) like this:
