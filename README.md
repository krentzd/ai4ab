...
Specific models trained on different sets of plates and imaging channels for all available versions) can be loaded by specifying the `revision` argument (see [Hugging Face repository](https://huggingface.co/krentzd/ai4ab):
